...
// const WAVEFORM_BARS = [
//   38, 52, 31, 43, 35, 58, 40, 47, 33, 42, 55, 37, 30, 45, 36, 49, 57, 41, 34,
//   44, 39, 53, 32, 46, 50, 36, 29, 42, 35, 48, 40, 33, 45, 37, 51, 43, 31, 39,
//   47, 35, 44, 32, 40, 49, 36, 42,
// ];
...
//   // inside PodcastPlayer:
//   const [waveWidth, setWaveWidth] = useState(0);
//   const [scrubPosition, setScrubPosition] = useState<number | null>(null);

//   const computeSeekValue = useCallback(
//     (x: number) => {
//       if (!waveWidth || !duration) return 0;
//       const clamped = Math.min(Math.max(x, 0), waveWidth);
//       return (clamped / waveWidth) * duration;
//     },
//     [waveWidth, duration],
//   );

//   // Use scrub position while dragging, real position otherwise
//   const displayPosition = scrubPosition ?? position;

//   const progress = useMemo(() => {
//     if (!duration || duration <= 0) return 0;
//     return Math.min(Math.max(displayPosition / duration, 0), 1);
...
//               activeOpacity={0.75}
//             >
//               <Ionicons name="play-back" size={13} color={colors.defaultIcon} />
...
//                 onStartShouldSetResponder={() => !controlsDisabled}
//                 onMoveShouldSetResponder={() => !controlsDisabled}
//                 onResponderGrant={(e) => {
//                   const v = computeSeekValue(e.nativeEvent.locationX);
//                   setScrubPosition(v);
//                   onSliderStart();
//                 }}
//                 onResponderMove={(e) => {
//                   setScrubPosition(computeSeekValue(e.nativeEvent.locationX));
//                 }}

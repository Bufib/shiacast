...
export default function PodcastPlayer({ podcast }: PodcastPlayerPropsType) {
  ...
  // Local fallback artwork (app logo)
  const logoAsset = Asset.fromModule(require("@/assets/images/icon.png"));
  ...
  // Use the remote cover for both the on-screen image and the
  // lock-screen / notification artwork metadata. Falls back to the
  // local logo while the signed URL is loading or if no image_filename.

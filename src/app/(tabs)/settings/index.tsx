          ...
          <View style={styles.section}>
            ...
            <View style={[styles.arabicDateSection, rtl && styles.rtl]}>
              ...
              <View style={[styles.dateAdjustControls, rtl && styles.rtl]}>
                ...
                >
                  <ThemedText style={styles.dateAdjustButtonText}>−</ThemedText>
                </Pressable>

                <Pressable onLongPress={resetArabicDate} delayLongPress={600}>
                  <View
                    style={[
                      styles.dateOffsetDisplay,
                      {
                        backgroundColor: Colors[colorScheme].cardBackground,
                      },
                    ]}
                  >
                    <ThemedText style={styles.dateOffsetText}>
                      {arabicDateOffset > 0
                        ? `+${arabicDateOffset}`
                        : `${arabicDateOffset}`}
                    </ThemedText>

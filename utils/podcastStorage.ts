...
// // Bestehender Code, der die alten Signed-URL-Funktionen verwendet,
// // funktioniert weiter, ohne dass `await` entfernt werden muss.

// /** @deprecated Buckets sind public — nutze stattdessen `getPublicImageUrls`. */
// export async function getSignedImageUrls(
//   filenames: string[],
// ): Promise<Record<string, string>> {
//   return getPublicImageUrls(filenames);
// }

// /** @deprecated Buckets sind public — nutze stattdessen `getImageUrl`. */
// export async function getSignedImageUrl(
//   filename?: string | null,
// ): Promise<string | null> {
...
// /** @deprecated Buckets sind public — nutze stattdessen `getPublicAudioUrl`. */
// export async function getSignedAudioUrl(filename: string): Promise<string> {
//   return getPublicAudioUrl(filename);
// }
